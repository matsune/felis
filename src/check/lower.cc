...
//         ty == Type::Kind::BOOL || ty == Type::Kind::STRING;
//}
//
...
//}
//
// std::unique_ptr<hir::Expr> Lower::MatchValueType(std::unique_ptr<hir::Value>
// e,
//                                                 std::shared_ptr<Type> ty) {
//  switch (e->ValueKind()) {
...
//}
//
// std::unique_ptr<hir::Expr> Lower::MatchBlockType(std::unique_ptr<hir::Block>
// e,
//                                                 std::shared_ptr<Type> ty) {
//  if (e->HasRet()) {
