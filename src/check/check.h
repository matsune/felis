...
//  //  std::unique_ptr<hir::RetStmt>
//  CheckRetStmt(std::unique_ptr<ast::RetStmt>);
...
//  //  MakeConstBinary(std::unique_ptr<hir::Constant>,
//  // std::unique_ptr<hir::Constant>,
//  //                                                 hir::Binary::Op);
//  //  std::unique_ptr<hir::Constant>
//  //  MakeConstUnary(std::unique_ptr<hir::Constant>,
//  //                                                hir::Unary::Op);
//  //
