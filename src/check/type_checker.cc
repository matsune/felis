...
//}
//
// StmtResult TypeChecker::CheckBlock(const ast::Block* block,
//                                   bool open_scope) {
...
//      throw LocError::Create(block->stmts.at(i + 1)->begin, "unreachable
//      code");
//    }
//  }
...
//    throw LocError::Create(stmt->expr->begin, "mismatched assign type %s =
//    %s",
//                           ToString(decl->type).c_str(),
//                           ToString(expr_ty).c_str());
//  }
//  return StmtResult::NonValue();
//}
//
// StmtResult TypeChecker::CheckExpr(const ast::Expr* expr) {
//  switch (expr->ExprKind()) {
//    case ast::Expr::Kind::LIT:
//      return CheckLit((ast::Lit*)expr);
//    case ast::Expr::Kind::IDENT:
//      return CheckIdent((ast::Ident*)expr);
//    case ast::Expr::Kind::BINARY:
//      return CheckBinary((ast::BinaryExpr*)expr);
//    case ast::Expr::Kind::UNARY:
//      return CheckUnary((ast::UnaryExpr*)expr);
//    case ast::Expr::Kind::CALL:
//      return CheckCall((ast::CallExpr*)expr);
//    case ast::Expr::Kind::ARRAY:
//      return CheckArray((ast::ArrayExpr*)expr);
//    case ast::Expr::Kind::IF:
//      return CheckIf((ast::If*)expr);
//    case ast::Expr::Kind::BLOCK:
//      return CheckBlock((ast::Block*)expr);
//  }
//}
//
// StmtResult TypeChecker::CheckLit(const ast::Lit* lit) {
...
//}
//
// StmtResult TypeChecker::CheckCall(const ast::CallExpr* call) {
