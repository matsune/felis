...
//  bool val;
//
//  BoolConstant(Loc begin, Loc end, bool val) : Constant(begin, end),
//  val(val){};
//
//  // override Stmt
...
//
//  Call(Loc begin, Loc end, std::shared_ptr<Decl> decl, unique_deque<Expr>
//  args)
...
//  std::unique_ptr<Expr> expr;
//
//  VarDeclStmt(Loc begin, std::shared_ptr<Decl> decl, std::unique_ptr<Expr>
//  expr)
...
//  std::unique_ptr<Expr> expr;
//
//  AssignStmt(Loc begin, std::shared_ptr<Decl> decl, std::unique_ptr<Expr>
//  expr)
//      : begin(begin), decl(decl), expr(std::move(expr)) {}
//
//  // override Stmt
